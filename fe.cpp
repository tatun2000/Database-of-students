...
FE::FE(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::FE)
{
    ui->setupUi(this);
    obj.exec("SELECT number_of_group FROM All_Groups WHERE id_facult = 3;");
    while(obj.next())
    {
...
void FE::Show_FE_Window()
{
    FE::show();
}

void FE::on_pushButton_clicked()
{
    FE::close();
    emit FE_Window_Close();
}

void FE::on_pushButton_4_clicked()
{
...
void FE::on_pushButton_5_clicked()
{
...
void FE::Print_Info_About_Of_Students()
{
...
void FE::on_listWidget_itemClicked()
{
...
void FE::on_pushButton_3_clicked()
{
...
void FE::on_pushButton_2_clicked()
{
...
void FE::Counting_The_Number_Of_Students_In_A_Group()
{
    int key = ui->listWidget->currentItem()->text().toInt();
    QString default_values = "0";
    QString values = map_with_number_of_groups.value(key,default_values); // id group
...
QStringList FE::Inizialisation_Titles_Of_Tables()
{
    QStringList value;
